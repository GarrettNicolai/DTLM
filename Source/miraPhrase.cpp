...
int main(int argc, char** argv)
{
	...
	try
	{
		...
		ValueArg<string> EmbInFilename("", "emb", "Filename of character embeddings file", false, "", "string", cmd);
		...
		myParam.EmbInFilename = EmbInFilename.getValue();
		...
		if (myParam.LMInFilename != "" || myParam.WCInFilename != "")
		{
